...
class DownloadableProductsView extends StatefulWidget {
  const DownloadableProductsView({super.key});
  static String route = 'downloadable';
  @override
  State<DownloadableProductsView> createState() => _DownloadableProductsViewState();
}

class _DownloadableProductsViewState extends State<DownloadableProductsView> {
  List<String> headers = ['Order', 'Date', 'Title', 'Status', 'Remaining Download'];
              ...
              children: [
                Flexible(
                  ...
                  child: ConstrainedBox(
                    ...
                    child: AccountSideBar(currentPage: DownloadableProductsView.route),
                  ),
                ),
                Expanded(
                  flex: 7,
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text('My downloadable products', style: AppStyles.getMediumTextStyle(fontSize: 18, color: AppColors.primaryColor)),
          ),
